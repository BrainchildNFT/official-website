    ...
    <div className="px-15 sm:px-40 lg:px-100 py-50 sm:py-70 xl:py-120">
      ...
      <div className="mt-10 flex flex-col xl:flex-row xl:flex-wrap">
        ...
        <div className="flex flex-col md:flex-row xl:flex-col xl:w-1/3">
          <div className="perk-and-utility-item-background border perk-and-utility-item-border relative h-500 m-10 overflow-hidden md:w-1/2 xl:w-auto">
        ...
        <div className="flex flex-col md:flex-row xl:flex-col xl:w-1/3">
          <div className="perk-and-utility-item-background border perk-and-utility-item-border relative h-500 m-10 flex flex-col justify-between overflow-hidden md:w-1/2 xl:w-auto">
            <div className="absolute top-30 right-30 z-30">
        ...
        <div className="flex flex-col md:flex-row xl:flex-col xl:w-1/3">
          <div className="perk-and-utility-item-background border perk-and-utility-item-border relative h-500 m-10 overflow-hidden md:w-1/2 xl:w-auto">
            ...
            <div className="px-10 pt-40">
              <p className="text-35 text-primary font-Future text-center break-words">Teleportable into crypto worlds</p>
            </div>
          </div>
          <div className="sm:p-10 m-10 mt-10 md:w-1/2 xl:w-auto">
