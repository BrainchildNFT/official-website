    ...
    <div className="container mx-auto flex flex-col justify-center items-center h-full">
      ...
      <div className="py-0 md:py-30 xl:py-50">
        ...
        <div className="flex flex-col md:flex-row justify-center mt-30 md:mt-60 w-full">
          <Link href="/" passHref><button className="btn btn-primary btn-lg mb-20 md:mb-0 w-full md:w-400">Go to Home Page</button></Link>
          <Link href="/collections" passHref><button className="btn btn-warning btn-lg md:ml-20 w-full md:w-400">Find Your Perfect Collections</button></Link>
        </div>
      </div>
