      ...
      <Layout>
        ...
        <div className="light-background-image overflow-hidden">
          ...
          <section className="relative pt-130 pb-60 border border-1">
            <div className="border-y border-gradient-dark p-25">
              <p className="text-primary-50 whitespace-nowrap transition eas-in-out transform -translate-y-1">Fermentum euismod sed pretium amet viverra odio ut. Mattis urna eget mi augue malesuada scelerisque sed consequat, non. Sagittis magnis ac, auctor dictum tristique turpis posuere. Fermentum euismod sed pretium amet viverra odio ut. Mattis urna eget mi augue malesuada scelerisque sed consequat, non.</p>
            </div>
            <div className="container mx-auto relative z-50">
              <div className="text-60 sm:text-95 lg:text-130 font-Voyage opacity-90 sm:opacity-75 lg:opacity-90 leading-tight text-primary-75 pt-60 lg:pb-195 text-left lg:text-center">
                <p>Immerse<br className="block lg:hidden"/> yourself<br className="hidden lg:block"/> <span className="text-45 sm:text-71 lg:text-80">in the</span> <br className="block lg:hidden"/>new age <span className="text-45 sm:text-71 lg:text-80">of</span></p>
            ...
            <div className="container mx-auto relative z-40 block lg:hidden mt-30 mb-70">
              <Image className="cursor-pointer z-40" src="/assets/images/common/ether-clock.png" layout="responsive" width={335} height={420} alt="Ethereum Clock" />
            </div>

            <div className="container mx-auto relative block lg:hidden text-primary-50 z-50">
              <p className="text-right">Fermentum euismod sed pretium amet viverra odio ut. Mattis urna eget mi augue malesuada scelerisque sed consequat, non. Sagittis magnis ac, auctor dictum tristique turpis posuere. Fermentum euismod sed pretium amet viverra odio ut. Mattis urna eget mi augue malesuada scelerisque sed consequat, non.</p>
            </div>
          </section>
          ...
          <section className="relative border border-1">
            <div className="container mx-auto flex flex-col pt-95 lg:pt-0 lg:items-center justify-center lg:h-screen">
              <div className="relative font-Voyage text-108 lg:text-130 text-primary-75 text-right pr-120 pb-120 lg:pr-100 lg:pb-100">
                <p className="leading-none sm:leading-tight"><span className="text-45 sm:text-66 lg:text-80">Experience</span> <span className="text-100 sm:text-120 lg:text-150">NFTs</span></p>
                <p className="text-45 sm:text-66 lg:text-80 leading-none sm:leading-tight">beyond the</p>
                <div className="absolute bottom-0 flex justify-end w-full">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 560 500" width="560" height="500">
                    <path fill="none" id="round" d="M0, 500L400,500C700,450,400,0,700,0L0"/>
                    <text x="25" className="fill-primary text-140 tracking-wider">
                      <textPath xlinkHref="#round">Crypto verse</textPath>
                    </text>
                  </svg>
                </div>
                <div className="absolute min-w-1200 top-0 right-0 -mr-400">
                  <Image src="/assets/images/landing-page/multi-line-chart.png" layout="responsive" width={950} height={450} alt="Multi Line Chart" />
                </div>
              </div>
              <div className="flex flex-col sm:flex-row lg:hidden pt-160 pb-80">
                <div className="relative flex justify-center pb-195 sm:pb-0 sm:w-1/2 px-20">
                  <Image className="cursor-pointer" src="/assets/images/landing-page/cartain-with-chair.png" layout="intrinsic" width={337} height={515} alt="Cartain With Chair" />
                  <div className="absolute w-full bottom-0 left-0 -ml-100 pb-50 block sm:hidden">
                    <Image src="/assets/images/landing-page/multi-polygon-dark.svg" layout="intrinsic" width={240} height={240} alt="Multi Polygon" />
                  </div>
                </div>
                <div className="flex items-end justify-center sm:w-1/2 px-20">
                  <p className="text-primary-50 text-justify">Mattis urna eget mi augue malesuada scelerisque sed consequat, non. Sagittis magnis ac, auctor dictum tristique turpis posuere. Fermentum euismod sed pretium amet viverra odio ut.</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="relative py-200 border border-1">
            <div className="flex justify-between items-center px-20 sm:px-80 xl:px-200">
              <p className="font-Voyage text-30 sm:text-50 text-primary-75">and more...</p>
              <div className="hidden lg:block">
                <Image src="/assets/images/landing-page/eye-on-line.png" layout="intrinsic" width={316} height={25} alt="Eye On Line" />
              </div>
            </div>
            <div className="mt-100 px-20 sm:px-80 lg:pr-0 xl:pl-200">
              <Swiper className="w-full" spaceBetween={80} breakpoints={swiperBreakPoints}>
                {nfts.map((nft, i) => (<SwiperSlide className="flex-grow" key={i}>
                  <div className="flex flex-col lg:flex-row">
                    ...
                    <div className="lg:max-w-350 lg:-ml-100 mt-50 relative z-50">
                      <span className="text-50 sm:text-80 text-primary-75 leading-none mb-20">{nft.name}</span>
                      <p className="mt-20 p-20 border border-gradient-dark-linner">{nft.content}</p>
                    </div>
                  </div>
                </SwiperSlide>))}
              </Swiper>
        ...
        <section className="relative dark-background-image border border-1">
          <div className="container mx-auto pt-50 sm:pt-200 text-white sm:text-center">
            ...
            <p className="text-justify sm:text-center break-all text-80 lg:text-100 xl:text-150">Collaborations</p>
            <p className="text-45 lg:text-80"><span className="text-30 lg:text-60">with</span> wondrous artists</p>
          </div>
          <div className="container mx-auto flex flex-col sm:flex-row items-center sm:justify-between mt-90 sm:mt-110 mb-50 sm:mb-300">
            ...
            <div className="text-white">
              <p className="sm:max-w-290">Et faucibus purus, ornare mi aliquam laoreet. Pretium, odio dis sit ipsum pretium elementum, pharetra vitae. A aliquam facilisi egestas pharetra iaculis. Pellentesque nisl convallis ornare augue nisl risus commodo, mi. Purus eget bibendum sit urna. Enim nunc, neque nunc felis massa magna massa porta.</p>
            </div>
          </div>
          <div className="absolute top-0 w-full h-full flex items-center justify-center">
            <Image src="/assets/images/landing-page/white-hand-draw-hourse.png" layout="intrinsic" width={792} height={818} alt="Hand Drawing White Hourse" />
          </div>
        </section>
        ...
        <section className="relative dark-background-image border border-1">
          <div className="py-45 sm:py-95 flex flex-col lg:flex-row">
            <div className="lg:w-1/3 flex lg:justify-center lg:items-center text-white">
              ...
              {currentFaqIndex === -1 && <p className="hidden lg:block text-130 vertical-letter">FAQ</p>}
              {currentFaqIndex !== -1 && <p className="hidden lg:block faq-content-background w-full h-full text-white text-24 font-semibold p-30 sm:pl-90 transition-all">{faqData[currentFaqIndex].content}</p>}
            </div>
