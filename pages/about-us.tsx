        ...
        <div className="dark-background-image">
          ...
          <section className="relative about-us-members-background">
            <div className="px-40 lg:px-100 xl:px-300 pb-100 lg:pb-120 xl:pb-150">
              ...
              <p className="font-Voyage text-60 lg:text-90 xl:text-100 text-white opacity-90 mt-30 lg:mt-150 xl:mt-300">KENSAN</p>
              ...
              <p className="font-Voyage text-60 lg:text-90 xl:text-100 text-white text-right opacity-90 mt-30 lg:mt-150 xl:mt-300">and more...</p>
