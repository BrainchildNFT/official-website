    ...
    <div className="px-20 sm:px-80 py-50 sm:py-70 xl:py-120">
      ...
      <div className="mt-10 flex flex-col xl:flex-row xl:flex-wrap">
        ...
        <div className="flex flex-col md:flex-row xl:flex-col xl:w-1/3">
          <div className="perk-and-utility-item-background border perk-and-utility-item-border relative h-450 h-450 m-20 overflow-hidden md:w-1/2 xl:w-auto">
        ...
        <div className="flex flex-col md:flex-row xl:flex-col xl:w-1/3">
          <div className="perk-and-utility-item-background border perk-and-utility-item-border relative h-450 m-20 flex flex-col justify-between overflow-hidden md:w-1/2 xl:w-auto">
            <div className="absolute top-30 right-30 z-30">
        ...
        <div className="flex flex-col md:flex-row xl:flex-col xl:w-1/3">
          <div className="perk-and-utility-item-background border perk-and-utility-item-border relative h-450 m-20 overflow-hidden md:w-1/2 xl:w-auto">
            <div className="absolute top-30 right-30 z-30">
