  ...
  return (<footer className="bg-black z-10 text-center lg:text-left text-light-400 py-100">
    <div className="container mx-auto">
      ...
      <div className="lg:flex justify-center mt-100 leading-10">
        <Link href="/"><a className="flex items-center justify-center"><Image className="cursor-pointer" src="/assets/images/logo-light-large.svg" width={201} height={63} alt="Brainchild logo" /></a></Link>
      </div>
    </div>
  </footer>);
}
