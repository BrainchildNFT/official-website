    ...
    <div className="flex flex-col xl:flex-row p-40 lg:p-100">
      <div className="xl:w-1/2 xl:pr-45 pb-50">
        ...
        <p className="mt-40 font-light leading-tight">
          9 years after Vitalik’s inception of Ethereum in 2013.<br/>
          7 years after Genesis Block One on 30th July 2015.<br/>
          A tribute collection matching Genesis Block One’s initial gas limit.<br/>
          Ethereum ushered
